...
export class ConfirmationService {
    ...
    async confirm<Type>(
        ...
        modalRef.componentInstance.header = options.header
            ? options.header
            : 'Confirmation';
        modalRef.componentInstance.icon = options.icon
            ? options.icon
            : 'fa fa-info-circle';
        modalRef.componentInstance.rejectIcon = options.rejectIcon
            ? options.rejectIcon
            : null;
        modalRef.componentInstance.acceptIcon = options.acceptIcon
            ? options.acceptIcon
            : null;
