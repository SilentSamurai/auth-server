...
@Component({
    ...
    template: `
        <div
            class="modal-header d-flex justify-content-between bg-primary-subtle px-0 pb-0 pt-2"
        >
                ...
                <div class="row mb-2">
                    <div class="col d-flex justify-content-between ">
                        <div class="mb-0 modal-title">
                            ...
                            <div class="p-disabled" style="font-size:small">
                                {{ subtitle }}
                            </div>
                        </div>
                        <div>
                ...
                <div class="row" *ngIf="tabs.length > 1">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        >
                            <button
                                class="nav-link {{
                                    isTabVisible(tab) ? 'tab-bottom-color' : ''
                                }}
        ...
        <div class="modal-body tab-content">
            <ng-container *ngFor="let tab of tabs">
                <div
                    *ngIf="isTabVisible(tab)"
                    class="tab-pane fade show {{
                        isTabVisible(tab) ? 'active' : ''
                    }}"
                >
                    <ng-container
