            ...
            <div class="row">
                ...
                <div class="col-4">
                    <form class="form-group g-3">
                        ...
                        <label class="col-3 col-form-label" for="Role">
                            Role
                        </label>
                        <app-value-help-input
...
export class RL02SelectionComponent implements OnInit {
    ...
    async continue() {
        console.log({
            'users': this.selectedRole,
            'tenant': this.selectedTenant
        });
        if (this.selectedTenant.length > 0 && this.selectedRole.length > 0) {
            await this.router.navigate([
                '/RL02', this.selectedTenant[0].id, this.selectedRole[0].name])
        }
    }
